        ...
        <div className="py-3 px-10 sm:px-4 md:px-6 1g:px-6">
            <div className="container mx-auto py-[2vh]">
                ...
                <div className="grid py-6 gap-8 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1">
                    <div className="food-card bg-red-500/25 rounded-xl flex flex-col cursor-pointer items-center p-5"> 
                        <div className="relative mb-3">
                            <img src="https://i.ibb.co/jMxb2GC/i5.png" alt="" srcset="" />
                            ...
                            <div className='absolute bottom-2 right-2'>
                                <button className="shadow-sm bottom-4 border-white text-white bg-[#fdc55e] cursor-pointer p-3 h-14 w-14 text-xl font-bold rounded-full relative">
                                    <div className='absolute text-xl top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2'>$100</div>
                                </button>
                            </div>
                        ...
                        <div className='flex gap-4 items-center'>
                            <p className='text-xl text-center font-bold text-[#f5474]'>
                                kebab
                            </p>
                    ...
                    <div className="food-card flex bg-red-500/25 rounded-xl flex-col cursor-pointer items-center p-5"> 
                        <div className="relative mb-3">
                            <img src="https://i.ibb.co/jMxb2GC/i5.png" alt="" srcset="" />
                            <div className="absolute top-2 left-2">
                                <button className="shadow-sm text-white bg-red-500 ☐hover:bg-red-700 cursor-pointer p-5 rounded-full relative">
                    ...
                    <div className="food-card bg-red-500/25 rounded-xl flex flex-col cursor-pointer items-center p-5"> 
                        <div className="relative mb-3">
                            <img src="https://i.ibb.co/jMxb2GC/15.png" alt="" srcset="" />
                            <div className="absolute top-2 left-2">
                                <button className="shadow-sm text-white bg-red-500 ☐hover:bg-red-700 cursor-pointer p-5 rounded-full relative">
                                    <FaHeart className='absolute text-xl top-1/2 left-1/2 -translate-x-1/2-translate-y-1/2'/>
                                </button>
